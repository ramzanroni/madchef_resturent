...
session_start();
$sql=$con->query("SELECT * FROM `branch` ORDER BY `branch`.`id` DESC");
$i=1;
?>
    ...
    while ($row=mysqli_fetch_assoc($sql)) 
    {
        ...
        <tr>
            ...
            <td class=" text-center">                 
                <a href="#"><i class="fas fa-trash text-danger m-1 float-left" onclick="del_branch(<?php echo $row['id']; ?>)"></i></a>
               
                 <a href="#"><i class="fa fa-edit m-1 float-left" data-toggle="modal" data-target="#exampleModal" onclick="branch_edit(<?php echo $row['id']; ?>)"></i></a>
