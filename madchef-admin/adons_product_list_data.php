...
$sql = mysqli_query($con,"SELECT * FROM `adons_product` WHERE `brand`='".$_SESSION['brand']."' AND `branch`='".$_SESSION['branch']."'");
  ...
  $(document).ready(function(){
          ...
          $('.quiz_deactivate').click(function (e) {
              ...
              if (isConfirm) {
                  ...
                  $.ajax({
                      'url': 'adons_product_list_dective.php',
                      'method': 'POST',
