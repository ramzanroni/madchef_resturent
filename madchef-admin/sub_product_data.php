...
session_start();
$sql=$con->query("SELECT * FROM `su_product` ORDER BY `su_product`.`id` DESC");
$i=1;
?>
        ...
        while ($row=mysqli_fetch_assoc($sql)) 
        {
            ...
            <tr>
                ...
                <td class=" text-center">
                 <a href="#"><i class="fa fa-edit m-1 float-left" data-toggle="modal" data-target="#exampleModal" onclick="subproduct_edit(<?php echo $row['id']; ?>)"></i></a> 
               ...
               <td class=" text-center">
                 ...
                 if($row['active']==Y){
                  ...
                  <td class=" text-center">
                    <a href="#"><i class="fas fa-trash text-danger m-1 float-left" onclick="del_sub(<?php echo $row['id']; ?>)"></i></a>                 </td>
                 <td>
                  <?php 
                  if($row['active']==Y){
                    echo "Active";
...
<script type="text/javascript">
    ...
    function subproduct_edit(id){
      // alert(id);
      $.ajax({
          url:"subproduct_edit.php",
          type:'post',
          data:{
            id:id
        },
